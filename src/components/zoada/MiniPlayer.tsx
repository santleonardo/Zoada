...
const MiniPlayer: React.FC = () => {
  ...
  return (
    <div
      className="fixed bottom-[4rem] left-0 right-0 z-40 glass border-t border-black/5 no-select"
      style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}
    >
      {/* Progress bar at top */}
      <div
        ref={progressRef}
        className="w-full h-[2px] bg-black/10 cursor-pointer group"
        onMouseDown={(e) => {
      ...
      <div className="flex items-center gap-3 px-3 py-2">
        ...
        <div className="flex items-center gap-1">
          ...
          >
            <Star
              size={18}
              className={isFav ? 'fill-[#FFD700] text-[#FFD700]' : 'text-black/30'}
            />
          </button>
          ...
          >
            <Heart
              size={18}
              className={isLiked ? 'fill-[#E84393] text-[#E84393]' : 'text-black/30'}
            />
          </button>
          ...
          >
            <ChevronUp size={18} className="text-black/50" />
          </button>
        </div>
      </div>
    </div>
